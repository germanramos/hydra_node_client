...
module.exports =  function () {
	...
	function setConfig(p_servers, p_options) {
		if (!!!p_servers || !!!p_servers.length) {
			throw "Empty hydra server list";
		}
		p_options = p_options || {};

		appServers['hydra'].list = (p_servers).slice();
	...
	function _Initialize(){
		...
		initialized = true;
		_GetHydraServers();
		timers.setInterval(_GetHydraServers, hydraTimeOut);
	}
